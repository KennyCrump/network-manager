module.exports = {
    ...
    addCompany: async (req, res) => {
        const {company_name, logo, description, location, linkedin, website } = req.body
        const {user_id} = req.session.user
        const db = req.app.get('db')
        ...
        let [newCompany] = await db.add_company({user_id, company_name, logo, description, location, website, linkedin})
